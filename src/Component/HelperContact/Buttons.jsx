...
const Buttons = ({contact}) => {
    ...
    return (
        <Box sx={{
            ...
            <IconButton sx={{ backgroundColor: isDark? "#198744" :lightgreen, width: { xs: 180, sm: 40 }, height: 40, borderRadius: 2, mt: 1.4, }} aria-label="see" onClick={() => {
                navigate(`/contacts/${contact.id}`);
            }}>
                <Visibility fontSize='inherit' />
            </IconButton>
            <IconButton sx={{ backgroundColor: isDark? darkblue: lightblue, width: { xs: 180, sm: 40 }, height: 40, borderRadius: 2, mt: 1.4, }} aria-label="edit" onClick={() => {
